//%attributes = {}
  ...
  // ----------------------------------------------------
  // User name (OS): if65
  // Date and time: 22/03/20, 22:36:58
  // ----------------------------------------------------
  // Method: catalinaCaricamento_ACPT
  // Description
  // 
  //
  // Parameters
...
If (Count parameters:C259=7)
	...
	If ($promoOk)
		...
		$promoVar:=utlProgressivoCrea (<>progPromovarPMT)
		If ($barcode="")
			$barcode:=utlOttieniBarcode8Catalina 
		End if 
		...
		OB SET:C1220($promozione;"tipo";"ACPT")
		OB SET:C1220($promozione;"descrizione";Choose:C955($repartoDescrizione="Total Store";"TOTALE SPESA";$repartoDescrizione))
		...
		OB SET:C1220($ricompensa;"descrizione";"ACPT")
		OB SET:C1220($ricompensa;"recordM";"00:ACPT-"+String:C10($codicePromozione))
		...
		If (OB Is defined:C1231(<>reparti;$repartoDescrizione))
