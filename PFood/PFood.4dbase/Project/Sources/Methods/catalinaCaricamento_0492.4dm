...
If (Count parameters:C259=7)
	...
	If ($promoOk)
		...
		$descrizione:="BUONO SCONTO "+String:C10(Round:C94($importo*100;0))+"%"
		
		
		$miscellaneo:=""
		If (OB Is defined:C1231(<>reparti;$repartoDescrizione))
			$descrizione:=$repartoDescrizione+" BUONO SCONTO "+String:C10(Round:C94($importo*100;0))+"%"
		...
		OB SET:C1220($promozione;"descrizione";"SCONTO")
