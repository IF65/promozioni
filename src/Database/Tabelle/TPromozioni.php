	...
	class TPromozioni {
        ...
        public function creaModifica(array $promozione) {
            ...
            $sql = "insert into $table 
                            (`id`,`codice`,`codiceCatalina`,`tipo`,`descrizione`,`ripetibilita`,`dataInizio`,`dataFine`,`oraInizio`,`oraFine`,
                                `calendarioSettimanale`,`tipoCliente`,`categoria`,`sottoreparti`,`bozza`,`stampato`,`pmt`,`barcode`,`testo`)
                    values
                            (:id,:codice,:codiceCatalina,:tipo,:descrizione,:ripetibilita,:dataInizio,:dataFine,:oraInizio,:oraFine,:calendarioSettimanale,
